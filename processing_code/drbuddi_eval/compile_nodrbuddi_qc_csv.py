...
qsiprep_dir = Path("/cbica/projects/hbcd_dev/pipeline_paper/penn-run/derivatives/no-drbuddi-1.0.0/qsiprep")
...
all_qc.to_csv("no_drbuddi_qc_1.0.0.csv", index=False)
